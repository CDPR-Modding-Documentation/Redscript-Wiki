...
* [How to create a hook](getting-started/how-to-create-a-hook/README.md)
  * [Things to hook](getting-started/how-to-create-a-hook/things-to-hook.md)

## Language Reference <a href="#language" id="language"></a>

* [Data Types](language/native-types.md)
* [Strings](language/strings.md)
* [Intrinsics](language/intrinsics.md)
* [Loops](language/loops.md)
* [Hook Annotations](language/hook-annotations.md)
* [Modules](language/modules.md)
* [Advanced Features](language/advanced-features/README.md)
  * [Conditional compilation](language/advanced-features/conditional-compilation.md)
  * [Configurable user hints](language/advanced-features/configurable-user-hints.md)
* [Utility functions](language/utility-functions/README.md)
  * [Math](language/utility-functions/math.md)
  * [Random](language/utility-functions/random.md)
  * [Logging](references-and-examples/logging.md)
  * [Utilities](language/utility-functions/utilities.md)

## References and examples

* [Logging](references-and-examples/logging.md)
* [Libraries](references-and-examples/libraries.md)
* [Scriptable systems](references-and-examples/scriptable-systems/README.md)
  * [Scriptables comparison](references-and-examples/scriptable-systems/scriptables-comparison.md)
...
* [Gameplay](references-and-examples/gameplay/README.md)
  * [Weapons](references-and-examples/gameplay/weapons.md)
  * [Vehicle system](references-and-examples/gameplay/vehicle-system.md)
