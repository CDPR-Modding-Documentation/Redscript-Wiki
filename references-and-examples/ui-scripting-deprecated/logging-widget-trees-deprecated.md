# Logging Widget Trees (Deprecated)
...
To learn more about logging, check [logging-deprecated.md](../logging-deprecated.md "mention")
...
You can add this code to your [`logs.reds`](../logging-deprecated.md) file:
