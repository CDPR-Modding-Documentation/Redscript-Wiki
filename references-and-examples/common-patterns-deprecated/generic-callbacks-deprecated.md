...
We return the result of the callback method as a `Variant`. User can convert the value by knowing the return type in advance, using [FromVariant](../../language/intrinsics-deprecated.md).
